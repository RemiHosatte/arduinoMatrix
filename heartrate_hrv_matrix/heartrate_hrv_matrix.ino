...
delay(1000);
     ...
     for (int row = 0 ; row <  3; row ++)
  {
    for (int col = 0; col < 5 ; col++)
    {
        ...
        matrix.drawPixel(2 + row, 4 + col, matrix.Color888(255, 255, 255));     
    }
  }
 ...
 /* for (int row = 0 ; row < 7; row ++)
  {
    for (int col = 0; col < 16 ; col++)
    {
      ...
      {
        matrix.drawPixel(originX + row, col, matrix.Color888(0, 0 , incre));
  ...
  matrix.fillRect(0, 0, 13, 16, matrix.Color888(0, 0 , incre));
  matrix.fillRect(20, 0, 32, 16, matrix.Color888(0, 0 , incre));
  */
  incre = incre + 1;
  if (incre > 50)
    incre = 20;
        ...
        case 1:
          ...
          if (timing < 10)
          {
            timing = 200;
             ...
             /* matrix.fillRect(0, 0, 12, 10, matrix.Color333(0, 0, 0));
